    ...
    <div className="relative overflow-hidden before:absolute before:top-0 before:start-1/2 before:bg-[url('https://preline.co/assets/svg/examples/polygon-bg-element.svg')] before:bg-no-repeat before:bg-top before:bg-cover before:size-full before:-z-[1] before:transform before:-translate-x-1/2 dark:before:bg-[url('https://preline.co/assets/svg/examples-dark/polygon-bg-element.svg')]">
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
        ...
        <div className="mt-5 max-w-3xl text-center mx-auto">
          <p className="text-lg text-gray-600 dark:text-gray-400">Empower. Collaborate. Elevate: Uniting Minds, Igniting Futures.</p>
        </div>
        ...
        <section className="mt-16">
          <h2 className="text-3xl font-bold text-center text-gray-800 dark:text-gray-200 mb-8">Tied Up Universities with Us</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8 justify-center">
            <CollegeLogo src="https://jyothyit.ac.in/wp-content/themes/jyothi/images/logo.png" alt="College 1 Logo" />
            <CollegeLogo src="https://www.iiits.ac.in/iiits-content/uploads/2020/04/logo1.png" alt="College 2 Logo" />
            <CollegeLogo src="https://rvpucollege.edu.in/wp-content/uploads/2022/11/Logo-2-300x121.png" alt="College 4 Logo" />
            <CollegeLogo src="https://vidyaniketan.edu.in/images/Vidyaniketan_Public_School.png?v=ats-cms.1.0" alt="College 5 Logo" />
